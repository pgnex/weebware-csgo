...
void GUI::render() noexcept {
	...
	if (g_weebware.menu_opened)
	{
		...
		if (tab_selection == legit) {
			...
			imgui_custom::horizontal_margin("legit22", 4);
	...
	// margin top column 1
			...
			ImGui::EndChild();
			ImGui::Separator();
			ImGui::PushStyleColor(ImGuiCol_Button, ConvertFromRGBA(ImVec4(40, 40, 40, 255)));
	...
	//		ImGui::VerticalSeparator();
		...
		//	ImGui::VerticalSeparator();
			...
			ImGui::BeginChild("AimbotSettings", ImVec2(0, 0), true);
			{
				...
				ImGui::Text("Recoil compensation (P/Y)");
				imgui_custom::a_better_slider_float("Recoil compensation P", &g_weebwarecfg.legit_cfg[g_weebwarecfg.legit_cfg_index].pitch_rcs, 0, 100, "%.0f%%");
				imgui_custom::a_better_slider_float("Recoil compensation Y", &g_weebwarecfg.legit_cfg[g_weebwarecfg.legit_cfg_index].yaw_rcs, 0, 100, "%.0f%%");
			...
			ImGui::BeginChild("Triggerbot", ImVec2(0, ImGui::GetContentRegionAvail().y / 3 * 2), true);
			{
				...
				ImGui::Checkbox("Enable##magnet", &g_weebwarecfg.legit_cfg[g_weebwarecfg.legit_cfg_index].magnet_triggerbot_enabled);
				ImGui::Text("Maximum FOV");
				imgui_custom::a_better_slider_float("FOV##magnettrigger", &g_weebwarecfg.legit_cfg[g_weebwarecfg.legit_cfg_index].magnet_trigger_fov, 0, 180.f, "%.1f");
				ImGui::Text("Sensitivity");
				imgui_custom::a_better_slider_float("Smooth##magnettrigger", &g_weebwarecfg.legit_cfg[g_weebwarecfg.legit_cfg_index].magnet_trigger_smooth, 0, 100.f, "%.1f");
				ImGui::Text("Target Switch Delay");
				imgui_custom::a_better_slider_int("Target Switch Delay##trigger", &g_weebwarecfg.legit_cfg[g_weebwarecfg.legit_cfg_index].triggerbot_target_switch_delay, 0, 2000, "%.0f");
				ImGui::Checkbox("Quickstop##magnet", &g_weebwarecfg.legit_cfg[g_weebwarecfg.legit_cfg_index].quick_stop_magnet);
			...
			ImGui::Columns(2, "Visuals", false);
			{
				...
				ImGui::BeginChild("Visuals 2", ImVec2(0, 0), true);
				{
					...
					if (g_weebwarecfg.enable_bullet_tracers) {
						...
						imgui_custom::a_better_slider_float("##tracerexpire", &g_weebwarecfg.bullet_tracer_expire, 0, 20, "%.2f");
						ImGui::Text("Width");
						imgui_custom::a_better_slider_float("Width##tracer", &g_weebwarecfg.bullet_tracer_width, 0, 10, "%.2f");
						ImGui::Text("Amplitude");
						imgui_custom::a_better_slider_float("Amplitude##tracer", &g_weebwarecfg.bullet_tracer_amplitude, 0, 10, "%.2f");
						ImGui::Text("Speed");
						imgui_custom::a_better_slider_float("Speed##tracer", &g_weebwarecfg.bullet_tracer_speed, 0, 2, "%.2f");
					}
		...
		if (tab_selection == tabs::misc) {
			ImGui::Columns(2, "Miscs", false);
			{
				ImGui::BeginChild("Misc 1", ImVec2(0, 0), true);
				{
					...
					//imgui_custom::a_better_slider_int("Tickcount mod", &g_weebwarecfg.tick_count_mod, 1, 20);
					//ImGui::Text("Command num mod");
					//imgui_custom::a_better_slider_int("Command num mod", &g_weebwarecfg.command_num_mod, 1, 20);
					//imgui_custom::a_better_slider_float("Yaw offset", &g_weebwarecfg.yaw_offset, -180, 180);
				}
				ImGui::EndChild();
				...
				ImGui::BeginChild("Misc 2", ImVec2(0, 0), true);
				{
					...
					imgui_custom::a_better_slider_float("Roatation Speed", &g_weebwarecfg.misc_ai_rotationspeed, 0, 100, "%.0f%%");
					ImGui::Text("Aim Speed");
					imgui_custom::a_better_slider_float("Aim Speed##ai", &g_weebwarecfg.misc_ai_aimspeed, 0, 100, "%.0f%%");
...
#pragma region skinchanger
		if (tab_selection == tabs::skins) {
			...
			ImGui::BeginChild("Gloves", ImVec2(0, ((skin_tab_height / 5) * 3) - 5), true);
			{
				...
				ImGui::Text("Wear");
				imgui_custom::a_better_slider_float("Wear##gloves", &g_weebwarecfg.glove_wearz, 0, 100, "%.0f%%");
				ImGui::Separator();
			...
			ImGui::InputText("##weaponname", g_weebwarecfg.skin_wheel[g_weebwarecfg.skinchanger_selected_gun].weapon_name, ARRAYSIZE(g_weebwarecfg.skin_wheel[g_weebwarecfg.skinchanger_selected_gun].weapon_name));
			ImGui::Text("Wear");
			imgui_custom::a_better_slider_float("Wear##skins", &g_weebwarecfg.skin_wheel[g_weebwarecfg.skinchanger_selected_gun].m_wear, 0, 100, "%.0f%%");
			ImGui::InputInt("Seed", &g_weebwarecfg.skin_wheel[g_weebwarecfg.skinchanger_selected_gun].m_seed);
			ImGui::Separator();
			ImGui::PushItemWidth(ImGui::GetContentRegionAvailWidth() - 5);
			ImGui::Text("Skins");
