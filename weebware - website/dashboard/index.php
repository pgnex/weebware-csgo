        ...
        <div class="main-info">
            ...
            <div class="column <?= !$user->subActive() ? 'no-sub-box' : null ?>">
                ...
                <div class="body">
                    ...
                    <?php if ($hwidStatus === 0) { ?> <button class="btn-main declined" disabled><i class="fas fa-exclamation-triangle"></i> Request denied</button> <?php } ?>
                    <?php if ($hwidStatus === -1) { ?> <button class="btn-main pending" disabled><i class="fas fa-spinner"></i> Pending Request</button> <?php } ?>
                    <?php if ($hwidStatus === 1 && $user->subActive()) { ?> <button class="btn-main" id="hwid_reset_open">Request HWID Reset</button> <?php } ?>
                </div>
            </div>
        </div>
        <div class="info-row">
